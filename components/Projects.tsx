...
const projects = [
  {
    ...
    color: "bg-slate-900",
    description:
      "A premium mobile phone and gadget shop in Mwenge, Dar es Salaam. We focus on high-end, latest devices and accessories from Apple, Samsung, Google Pixel, Guess, Polo, Santa Barbara, Pitaka, Aulumu, Anker, Powerology, Green Lion and Beats.",
    tech: [
      "Apple",
      "Samsung",
      "Google Pixel",
            ...
            return (
              ...
              >
                <div className="flex items-center justify-between mb-6">
                  ...
                  <span className={project.color + " text-white px-4 py-2 rounded-full text-sm font-semibold"}>
                    {project.status}
                  </span>
                </div>
